...
const STEPS = [
  {
    emoji: "👋",
    title: (name: string) => `Привет, ${name || "студент"}!`,
    subtitle: "Аккаунт создан - ты на верном пути",
    desc: "Добро пожаловать на полный курс по продакт-менеджменту. Ты пройдёшь путь от основ до реальных кейсов - с AI-поддержкой на каждом шагу.",
    features: null,
  },
  {
    emoji: "📚",
