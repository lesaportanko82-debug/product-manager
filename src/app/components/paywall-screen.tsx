    ...
    <div className="flex-1 min-h-screen overflow-y-auto bg-gradient-to-br from-slate-50 via-white to-teal-50/40 dark:from-slate-950 dark:via-slate-900 dark:to-teal-950/20 flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        ...
        >
          ...
          {/* ── CIS Payment Block ── */}
          <div className="mx-6 mb-7 rounded-2xl overflow-hidden border border-teal-100 dark:border-teal-800/40 bg-gradient-to-br from-slate-50 to-teal-50/60 dark:from-slate-800/60 dark:to-teal-900/20 relative">
