    ...
    <div ref={containerRef} className="flex-1 min-h-screen max-h-screen bg-gradient-to-br from-slate-200 via-slate-100 to-teal-100/50 dark:from-slate-900 dark:via-slate-800 dark:to-teal-950/50 overflow-y-auto">
      ...
      <AnimatePresence mode="wait" initial={false}>
        ...
        >
          ...
          {/* UX/UI interactive visual blocks (m-uxui & m18) */}
          {(module.id === "m-uxui" || module.id === "m18") && (
            <FadeIn delay={0.08}>
              <UXUIVisualContent lessonId={lesson.id} />
            </FadeIn>
          )}
          ...
          {/* Telegram banner — last lesson of module 25 (m18-l7) */}
          {lesson.id === "m18-l7" && (
            <FadeIn>
              <YaroslavTelegramBanner />
            </FadeIn>
          )}
